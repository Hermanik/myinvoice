    ...
    <div v-else-if="summary && summary.kpi" class="space-y-6">
      ...
      <section class="space-y-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div v-for="c in summary.kpi.per_currency" :key="c.currency"
            class="bg-surface border border-neutral-200 rounded-lg p-5 shadow-sm md:col-span-2">
      ...
      <section v-if="(summary.kpi.purchase_count_ytd ?? 0) > 0" class="space-y-3">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <RouterLink to="/crm"
            class="bg-surface border border-neutral-200 rounded-lg p-5 shadow-sm hover:bg-neutral-50 hover:border-primary-300 transition">
